...
export function useVisualNovel(scriptText, skipReset = false) {
  ...
  // Helper function to skip pose, sprite, hide-sprites, and video items and update state
  const skipNonContentItems = (gameState, setterFunctions = {}) => {
    ...
    while (
      ...
      if (content.type === "pose") {
        ...
        // Video items should be merged with following dialogue
        // Don't return yet, continue to next content
        gameState.advance();
